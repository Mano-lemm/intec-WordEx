...
public class WordGetResponse {
    private String word;
    private String translation;

    public WordGetResponse(String word, String translation) {
        this.word = word;
        this.translation = translation;
    }

    public WordGetResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof WordGetResponse)) return false;
        final WordGetResponse other = (WordGetResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof WordGetResponse;
    }
    ...
    public String toString() {
        return "WordGetResponse(word=" + this.getWord() + ", translation=" + this.getTranslation() + ")";
    }
}
